...
workflow {{ project_name }} {
    ...
    call Core.Core as Core {
        input:
            ...
            QFILTER_MIN_QUAL=QFILTER_MIN_QUAL,
            QFILTER_MIN_READ_FRAC=QFILTER_MIN_READ_FRAC,
            MIN_READ_LENGTH=MIN_READ_LENGTH,
            KEEP_RANDOM_BARCODE_STATS=KEEP_RANDOM_BARCODE_STATS,
            MAIN_ORGANISM_GENOME_ID=MAIN_ORGANISM_GENOME_ID,
            STAR_alignEndsType=STAR_alignEndsType,
            STAR_outFilterMatchNmin=STAR_outFilterMatchNmin,
            STAR_outFilterMatchNminOverLread=STAR_outFilterMatchNminOverLread,
            STAR_outFilterMismatchNmax=STAR_outFilterMismatchNmax,
